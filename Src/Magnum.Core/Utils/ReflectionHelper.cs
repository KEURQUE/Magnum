...
namespace Magnum.Core.Utils
{
  public static class ReflectionHelper
  {
    ...
    public static void ValidatePublicPropertyName( object sourceObject, string propertyName )
    {
    ...
    /// <param name="propertyName">The name of the property.</param>
    [System.Diagnostics.Conditional( "DEBUG" )]
    public static void ValidatePropertyName( object sourceObject, string propertyName )
    {
      if( sourceObject == null )
        throw new ArgumentNullException( "sourceObject" );
    ...
    public static bool TryGetEnumDescriptionAttributeValue( Enum enumeration, out string description )
    {
      try
      {
    ...
    [DebuggerStepThrough]
    public static string GetPropertyOrFieldName( MemberExpression expression )
    {
    ...
    [DebuggerStepThrough]
    public static bool TryGetPropertyOrFieldName( MemberExpression expression, out string propertyOrFieldName )
    {
    ...
    [DebuggerStepThrough]
    public static bool TryGetPropertyOrFieldName<TMember>( Expression<Func<TMember>> expression, out string propertyOrFieldName )
    {
      propertyOrFieldName = null;
