...
using Magnum.Controls.PropertyGrid.Editors;
...
namespace Magnum.Controls.PropertyGrid
{
  internal abstract class ObjectContainerHelperBase : ContainerHelperBase
  {
    ...
    private void RegenerateProperties()
    {
      ...
      Magnum.Controls.PropertyGrid.PropertyGrid propertyGrid = PropertyContainer as Magnum.Controls.PropertyGrid.PropertyGrid;
