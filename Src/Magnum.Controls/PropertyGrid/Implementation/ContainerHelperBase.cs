...
namespace Magnum.Controls.PropertyGrid
{
  public abstract class ContainerHelperBase
  {
    ...
    public virtual void PrepareChildrenPropertyItem( PropertyItemBase propertyItem, object item ) 
    {
      ...
      Magnum.Controls.PropertyGrid.PropertyGrid.RaisePreparePropertyItemEvent( ( UIElement )PropertyContainer, propertyItem, item );
    }
    ...
    public virtual void ClearChildrenPropertyItem( PropertyItemBase propertyItem, object item )
    {
      ...
      Magnum.Controls.PropertyGrid.PropertyGrid.RaiseClearPropertyItemEvent((UIElement)PropertyContainer, propertyItem, item);
    }
